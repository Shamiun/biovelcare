...
export default function Footer() {
  return (
    <footer className="relative z-10 mt-8 w-full overflow-hidden pb-8 pt-16">
      ...
      <div className="glass relative flex  flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start lg:ml-20">
          ...
          <p className="mb-6 max-w-xs text-center text-md text-foreground md:text-left">
            Digital Compass is your essential guide to the future of tech,
            science, and AI. We provide clear, insightful analysis on the latest
            breakthroughs to help you navigate a complex digital world.
          </p>
        ...
        <nav className="flex w-full flex-col gap-9 text-center lg:mr-20 md:flex-row md:justify-end md:text-left">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/all-categories" className="text-foreground/70">
                  All Categories
                </Link>
              </li>
              {/* <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/categories/gaming" className="text-foreground/70">
                  Gaming
                </Link>
              </li>
              <li>
                <Link href="/categories/ai" className="text-foreground/70">
                  Ai
                </Link>
              </li>
            </ul>
      ...
      <div className="relative z-10 mt-10 text-center text-xs text-foreground">
        <span>&copy; 2025 Digital Compass. All rights reserved.</span>
      </div>
    </footer>
  );
}
